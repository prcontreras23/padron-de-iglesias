...
export default async function handler(req, res) {
  ...
  const { ok, data } = await sbFetch('solicitudes_iglesias?select=id,created_at,nombre_congregacion,nombre_pastor,zona,distrito,estado,codigo_asignado&order=created_at.desc');
